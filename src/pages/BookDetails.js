...
export const BookDetails = () => {
    ...
    return (
        ...
        >
            <div className="absolute top-30 right-20 mt-4 mr-4 w-80 bg-white bg-opacity-90 p-4 rounded-lg shadow-lg">
                ...
                {chapter ? (
                    <div className="flex flex-col items-center bg-white bg-opacity-80 p-8 rounded-lg shadow-lg">
                        ...
                        <div className="flex flex-col space-y-4">
                            ...
                            <button
                                className={`py-2 px-4 rounded font-bold transition duration-300 ${
                                    followedBook ? 'bg-green-500 hover:bg-green-700' : 'bg-gray-500 hover:bg-gray-700'
                                }`}
                            ...
                            <button
                                className={`py-2 px-4 rounded font-bold transition duration-300 ${
                                    followedAuthor ? 'bg-green-500 hover:bg-green-700' : 'bg-gray-500 hover:bg-gray-700'
                                }`}

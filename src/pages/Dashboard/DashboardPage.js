...
export const DashboardPage= () => {
  return (
    ...
    <div className="p-4 w-full">
      <div className="w-full bg-gray-100 border border-gray-200 rounded-lg">
          ...
          <div className="flex flex-row justify-between items-center pb-10 w-4/5 mx-auto">
            <div className="flex flex-col items-center">
                <img className="w-40 h-40 mb-3 rounded-full shadow-lg" src={UserProfile} alt="User profile" />
                <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">Bonnie Green</h5>
                <span className="text-sm text-gray-500 dark:text-gray-400">Writer</span>
            </div>
            <div className="flex flex-row mt-4 md:mt-6 pr-10">
                <Link to="#" className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add friend</Link>

        ...
        <aside id="default-sidebar" className="left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
          <div className="h-full px-3 py-4 overflow-y-auto">
            <ul className="space-y-2 font-medium">
              <li>
                <Link to="/dashboard" className={`flex items-center p-2 text-gray-900 hover:rounded-lg ${activeTab === 'dashboard'? '' : 'hover:' }bg-gray-100 group`}>
              ...
              <li>
                <Link to="profile" className={`flex items-center p-2 text-gray-900 hover:rounded-lg ${activeTab === 'profile'? '' : 'hover:' }bg-gray-100 group`}>
                  <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <Link to="#" className={`flex items-center p-2 text-gray-900 hover:rounded-lg ${activeTab === 'create book'? '' : 'hover:'}bg-gray-100 group`}>
              ...
              <li>
                <Link to="membership" className={`flex items-center p-2 text-gray-900 hover:rounded-lg ${activeTab === 'membership'? '' : 'hover:'}bg-gray-100 group`}>
                <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
